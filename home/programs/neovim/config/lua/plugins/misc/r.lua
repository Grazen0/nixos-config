local function extra_config()
  ...
  vim.api.nvim_create_autocmd('FileType', {
    ...
    callback = function()
      ...
      buf_create_user_command(bufnr, 'RStart', function()
        r_run.start_R('R')
      end, {
      ...
      buf_create_user_command(bufnr, 'ROBOpenLists', function()
        r_browser.open_close_lists('O')
      end, {
        desc = 'Open S4 objects, lists and data.frames in the Object Browser',
      })

      buf_create_user_command(bufnr, 'ROBCloseLists', function()
...
require('lib.misc').setup_on_ft({ 'r', 'quarto' }, 'r', {
